...
http_server: $(http_server_OBJ) $(connection_handler_OBJ) $(parse_header_OBJ)
	@echo 'Building: $@'
	$(CC) -fsanitize=address -g http_server.o connection_handler.o parse_header.o -o http_server
